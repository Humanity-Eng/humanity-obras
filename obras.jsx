...
const VERSAO="2026.08.26 · build 32";
...
export default function App(){
 ...
 const TE=["Dashboard","Cronograma","Medições","Materiais","Estoque","Compras","Colaboradores","Comunicação"];
 ...
 {tab===5&&<Compras CP={D.compras||[]} sv={v=>sv("compras",v)} svE={v=>sv("estoque",v)} ES={D.estoque||[]} obra={obra}/>}
 {tab===6&&<Colaboradores E={D.equipe||[]} sv={v=>sv("equipe",v)} podeEditar={true}/>}
 {tab===7&&<Comunicacao C={D.custos||[]} sv={v=>sv("custos",v)} msgs={D.msgs||[]} svM={v=>sv("msgs",v)} user={user} engOnly={true}/>}
 </>}
 {role==="cli"&&<>
