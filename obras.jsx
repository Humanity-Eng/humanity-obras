...
const VERSAO="2026.09.03 · build 48";
       ...
       <div>
        <div style={{maxHeight:340,overflowY:"auto",border:"1px solid #e2e8f0",borderRadius:8,padding:8,background:"#fff"}}>
         <div id="rdo-pdf" style={{background:"#fff",padding:14,fontFamily:"Arial,sans-serif",width:"185mm"}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-end",borderBottom:"2px solid #f8c400",paddingBottom:7,marginBottom:9}}>
           <Logo h={26}/>
           <div style={{textAlign:"right"}}>
            <div style={{fontSize:13,fontWeight:800,color:"#1e2d5a",letterSpacing:0.5}}>DIÁRIO DE OBRA — RDO</div>
            <div style={{fontSize:7.5,color:"#64748b"}}>Registro Diário de Ocorrências</div>
           </div>
          </div>
          <div style={{fontSize:7,color:"#94a3b8",marginBottom:8}}>Humanity Engenharia Ltda · CNPJ 48.217.552/0001-82 · Travessa Lomas Valentinas, 1215 — Pedreira, Belém/PA</div>
...
function CabecaImp({titulo,obra,extra}){
 return(
  <div style={{marginBottom:14}}>
   <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-end",borderBottom:"3px solid #f8c400",paddingBottom:8}}>
    <Logo h={30}/>
    <div style={{textAlign:"right"}}>
     <div style={{fontSize:19,fontWeight:800,color:"#1e2d5a",letterSpacing:0.5}}>{titulo}</div>
   ...
   <div style={{fontSize:12,color:"#475569",marginTop:7,fontWeight:700}}>
...
function ImpressaoAvanco({A,obra}){
 ...
 return(
  <BotaoImprimir id="imp-avanco" nome={"Avanco_"+(obra?obra.nome.replace(/[^a-zA-Z0-9]/g,"_"):"obra")+".pdf"}
   ...
   <div style={{fontSize:9,color:"#94a3b8",textAlign:"center",marginTop:10}}>Humanity Engenharia · gestão à vista · atualizar semanalmente</div>
  </BotaoImprimir>
 );
}
