...
const VERSAO="2026.08.30 · build 40";
       ...
       <div>
        <div style={{maxHeight:340,overflowY:"auto",border:"1px solid #e2e8f0",borderRadius:8,padding:8,background:"#fff"}}>
         <div id="rdo-pdf" style={{background:"#fff",padding:14,fontFamily:"Arial,sans-serif",width:"185mm"}}>
          <div style={{textAlign:"center",borderBottom:"2px solid #f8c400",paddingBottom:6,marginBottom:8}}>
           <div style={{fontSize:13,fontWeight:800,color:"#1e2d5a"}}>DIÁRIO DE OBRA — RDO</div>
           <div style={{fontSize:8,color:"#64748b"}}>Registro Diário de Ocorrências · Humanity Engenharia Ltda · CNPJ 48.217.552/0001-82</div>
          </div>
                  ...
                  {[0,1].map(j=>{
                   ...
                   return(
                    <td key={j} style={{...td,width:"50%",textAlign:"center",padding:6}}>
                     {f?(<>
                      <img src={f.full} alt="" style={{width:"100%",maxHeight:62+"mm",objectFit:"cover",borderRadius:3}}/>
                      <div style={{fontSize:8,color:"#475569",marginTop:3,textAlign:"left"}}>
                       <b>Foto {i+j+1}.</b> {f.legenda||"—"}
                      </div>
                     </>):null}
                    </td>
                   );
