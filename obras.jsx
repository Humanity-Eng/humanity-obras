...
const VERSAO="2026.08.28 · build 36";
...
export default function App(){
 ...
 ],rec:IR,emp:IE_DEFAULT,emprestimos:[],lidos:{},crono:{},tarefas:[],equipe:[],fornecedores:[]};
 ...
 if(!obraId)return <ObrasList user={user} obras={obras} onSel={id=>{setObraId(id);setTab(0);}} onOut={()=>setUser(null)}
    onNova={o=>{
     ...
     const vazio={caixa:{saldo:0,hist:[]},custos:[],acomp:[],estoque:[],consumo:[],msgs:[],compras:[],rec:[],emp:[],emprestimos:[],lidos:{},crono:{},tarefas:[],equipe:[],fornecedores:[]};
 ...
 const TA=["Dashboard","Atividades","Orçamento","Custos","Recebimentos","Caixa","Empréstimo","Cronograma","Medições","Empreitada","Estoque","Compras","Colaboradores","Fornecedores","Comunicação"];
 const TE=["Dashboard","Cronograma","Medições","Materiais","Estoque","Compras","Colaboradores","Fornecedores","Comunicação"];
 ...
 {tab===11&&<Compras CP={D.compras||[]} sv={v=>sv("compras",v)} svE={v=>sv("estoque",v)} ES={D.estoque||[]} obra={obra} FS={D.fornecedores||[]}/>}
     {tab===12&&<Colaboradores E={D.equipe||[]} sv={v=>sv("equipe",v)} podeEditar={true}/>}
     {tab===13&&<Fornecedores FS={D.fornecedores||[]} sv={v=>sv("fornecedores",v)} podeEditar={true}/>}
     {tab===14&&<Comunicacao C={D.custos||[]} sv={v=>sv("custos",v)} msgs={D.msgs||[]} svM={v=>sv("msgs",v)} user={user}/>}
 </>}
 {ehEquipe&&<>
 {tab===0&&<DashboardEng D={D} obra={obra}/>}
 {tab===1&&<CronogramaEquipe D={D} obra={obra}/>}
 {tab===2&&<Medicoes A={D.acomp||[]} sv={v=>sv("acomp",v)} obra={obra} user={user} svM={v=>sv("msgs",v)} msgs={D.msgs||[]}/>}
 {tab===3&&<Materiais C={D.custos||[]}/>}
 {tab===4&&<Estoque ES={D.estoque||[]} CON={D.consumo||[]} svE={v=>sv("estoque",v)} svC={v=>sv("consumo",v)}/>}
 {tab===5&&<Compras CP={D.compras||[]} sv={v=>sv("compras",v)} svE={v=>sv("estoque",v)} ES={D.estoque||[]} obra={obra} FS={D.fornecedores||[]}/>}
 {tab===6&&<Colaboradores E={D.equipe||[]} sv={v=>sv("equipe",v)} podeEditar={true}/>}
 {tab===7&&<Fornecedores FS={D.fornecedores||[]} sv={v=>sv("fornecedores",v)} podeEditar={true}/>}
 {tab===8&&<Comunicacao C={D.custos||[]} sv={v=>sv("custos",v)} msgs={D.msgs||[]} svM={v=>sv("msgs",v)} user={user} engOnly={true}/>}
 </>}
 {role==="cli"&&<>
