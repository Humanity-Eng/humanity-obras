...
const VERSAO="2026.08.30 · build 42";
...
export default function App(){
 ...
 ],rec:IR,emp:IE_DEFAULT,emprestimos:[],lidos:{},crono:{},tarefas:[],equipe:[],fornecedores:[],rdos:[]};
 ...
 if(!obraId)return <ObrasList user={user} obras={obras} onSel={id=>{setObraId(id);setTab(0);}} onOut={()=>setUser(null)}
    onNova={o=>{
     ...
     const vazio={caixa:{saldo:0,hist:[]},custos:[],acomp:[],estoque:[],consumo:[],msgs:[],compras:[],rec:[],emp:[],emprestimos:[],lidos:{},crono:{},tarefas:[],equipe:[],fornecedores:[],rdos:[]};
 ...
 const TX=["Avanço da Obra","Diário de Obra"]; // encarregado
 ...
 {tab===11&&<Estoque ES={D.estoque||[]} CON={D.consumo||[]} svE={v=>sv("estoque",v)} svC={v=>sv("consumo",v)}/>}
 ...
 {tab===5&&<Estoque ES={D.estoque||[]} CON={D.consumo||[]} svE={v=>sv("estoque",v)} svC={v=>sv("consumo",v)}/>}
