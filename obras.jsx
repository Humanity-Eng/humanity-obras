 ...
 return(
  <div>
   ...
   <div style={{background:"#1e2d5a",borderRadius:14,padding:20,marginBottom:20,textAlign:"center"}}>
    ...
    <div style={{fontSize:10,color:"#64748b",marginTop:6,maxWidth:400,margin:"6px auto 0"}}>Empréstimos e aportes extras entram como parcela em Recebimentos e o pagamento (com juros) entra em Custos — refletindo aqui automaticamente.</div>
   </div>
