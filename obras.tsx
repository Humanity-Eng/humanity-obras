...
const VERSAO="2026.08.18 · build 20";
...
export default function App(){
 ...
 if(chaveDef==="madalena"){
  ...
  defs.crono={inicio:"01/08/2026",meses:6};defs.tarefas=IT_MADALENA;defs.compras=CP_MADALENA;
 }
 const nd={};
 ...
 {tab===11&&<Compras CP={D.compras||[]} sv={v=>sv("compras",v)} svE={v=>sv("estoque",v)} ES={D.estoque||[]}/>}
...
const IR_MADALENA=[
 {data:"Medição ago/26",venc:"30/09/2026",prev:122252.85,rec:0,obs:"Recebimento no mês seguinte à medição"},
 {data:"Medição set/26",venc:"30/10/2026",prev:242208.80,rec:0,obs:"Recebimento no mês seguinte à medição"},
 {data:"Medição out/26",venc:"30/11/2026",prev:151152.22,rec:0,obs:"Recebimento no mês seguinte à medição"},
 {data:"Medição nov/26",venc:"30/12/2026",prev:262757.61,rec:0,obs:"Recebimento no mês seguinte à medição"},
 {data:"Medição dez/26",venc:"30/01/2027",prev:210807.23,rec:0,obs:"Recebimento no mês seguinte à medição"},
 {data:"Medição jan/27",venc:"28/02/2027",prev:210821.29,rec:0,obs:"Recebimento no mês seguinte à medição"},
];
