...
const VERSAO="2026.08.26 · build 31";
...
export default function App(){
 ...
 for(const k of Object.keys(defs)){
     ...
     if(k==="acomp"&&obraId==="lote_d18"&&v&&Array.isArray(v)&&v.length>0){
      ...
      if(k==="rec"&&Array.isArray(v)&&v.length>0){
...
const IR_MADALENA=[
 {data:"Medição ago/26",venc:"30/09/2026",prev:175968.54,rec:0,obs:"Recebimento no mês seguinte à medição"},
 {data:"Medição set/26",venc:"30/10/2026",prev:274928.96,rec:0,obs:"Recebimento no mês seguinte à medição"},
 {data:"Medição out/26",venc:"30/11/2026",prev:262681.01,rec:0,obs:"Recebimento no mês seguinte à medição"},
 {data:"Medição nov/26",venc:"30/12/2026",prev:282761.87,rec:0,obs:"Recebimento no mês seguinte à medição"},
 {data:"Medição dez/26",venc:"30/01/2027",prev:249017.44,rec:0,obs:"Recebimento no mês seguinte à medição"},
];
