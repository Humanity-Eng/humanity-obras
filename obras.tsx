...
const VERSAO="2026.09.02 · build 47";
...
export default function App(){
 ...
 {tab===11&&<Estoque ES={D.estoque||[]} CON={D.consumo||[]} svE={v=>sv("estoque",v)} svC={v=>sv("consumo",v)} CAU={D.cautelas||[]} svCau={v=>sv("cautelas",v)} EQ={D.equipe||[]}/>}
 ...
 {tab===5&&<Estoque ES={D.estoque||[]} CON={D.consumo||[]} svE={v=>sv("estoque",v)} svC={v=>sv("consumo",v)} CAU={D.cautelas||[]} svCau={v=>sv("cautelas",v)} EQ={D.equipe||[]}/>}
 ...
 {tab===1&&<Diario D={D} obraId={obraId} obra={obra} user={user} RD={D.rdos||[]} sv={v=>sv("rdos",v)}/>}
 {tab===2&&<CronogramaEquipe D={D} obra={obra}/>}
 {tab===3&&<Estoque ES={D.estoque||[]} CON={D.consumo||[]} svE={v=>sv("estoque",v)} svC={v=>sv("consumo",v)} CAU={D.cautelas||[]} svCau={v=>sv("cautelas",v)} EQ={D.equipe||[]}/>}
...
function Estoque({ES,CON,svE,svC,CAU,svCau,EQ}){
