...
const USERS={
  ...
  "josecarlos@humanityengenharia.com":{pw:"jose2026",role:"enc",nome:"José Carlos",obras:["obra_madalena","madalena"]},
...
const VERSAO="2026.09.18 · build 49";
...
function marcaDaObra(obra){
 return chaveObra(obra?obra.id:"",obra)==="madalena"?MARCAS.umare:MARCAS.humanity;
}
...
const OBRAS_REF=[{id:"obra_madalena",nome:"EMEIF MADALENA RAAF — Reforma",cliente:"Prefeitura Municipal de Belém",local:"Belém/PA",inicio:"01/08/2026",contrato:1325492.54,status:"Em andamento"}];
...
export default function App(){
 ...
 const TX=["Avanço da Obra","Diário de Obra","Cronograma","Estoque","Compras","Comunicação"]; // encarregado
 const TC=["Avanço da Obra","Meus Pagamentos"];
 const ehEquipe=role==="eng"||role==="est"; // engenheira e estagiária veem as mesmas abas
 const tabs=role==="admin"?TA:ehEquipe?TE:role==="enc"?TX:TC;
 ...
 <div style={{position:"relative",display:"inline-flex",alignItems:"center",gap:6}}>
  ...
  <div style={{display:"flex",alignItems:"center",gap:6,padding:"0 0 6px 4px",borderTop:"1px solid #f1f5f9"}}>
   <div style={{width:6,height:6,borderRadius:"50%",background:role==="admin"?"#f8c400":ehEquipe?"#3b82f6":role==="enc"?"#8b5cf6":"#10b981",flexShrink:0}}/>
   <div style={{fontSize:11,color:"#64748b"}}>{user.nome} <span style={{color:"#94a3b8"}}>·</span> <span style={{color:"#94a3b8"}}>{role==="admin"?"Administrador":role==="eng"?"Engenheira Civil":role==="est"?"Estagiária":role==="enc"?"Encarregado":"Cliente"}</span></div>
  </div>
 </div>
 ...
 {tab===1&&<Diario D={D} obraId={obraId} obra={obra} user={user} RD={D.rdos||[]} sv={v=>sv("rdos",v)}/>}
 {tab===2&&<CronogramaEquipe D={D} obra={obra}/>}
 {tab===3&&<Estoque ES={D.estoque||[]} CON={D.consumo||[]} svE={v=>sv("estoque",v)} svC={v=>sv("consumo",v)} CAU={D.cautelas||[]} svCau={v=>sv("cautelas",v)} EQ={D.equipe||[]} obra={obra}/>}
 {tab===4&&<Compras CP={D.compras||[]} sv={v=>sv("compras",v)} svE={v=>sv("estoque",v)} ES={D.estoque||[]} obra={obra} FS={D.fornecedores||[]}/>}
