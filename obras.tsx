...
const VERSAO="2026.09.24 · build 57";
...
const IR_NAVEGANTES=[
 {data:"Medição out/26",venc:"30/11/2026",prev:242273.85,rec:0,obs:"Recebimento no mês seguinte à medição"},
 {data:"Medição nov/26",venc:"31/12/2026",prev:203872.58,rec:0,obs:"Recebimento no mês seguinte à medição"},
 {data:"Medição dez/26",venc:"31/01/2027",prev:118856.21,rec:0,obs:"Recebimento no mês seguinte à medição"},
];
...
const OBRAS_REF=[
 ...
 {id:"obra_navegantes",nome:"UP NAVEGANTES — Reforma",cliente:"SEMEC — Secretaria Municipal de Educação",local:"Belém/PA",inicio:"01/10/2026",contrato:565002.64,status:"Em andamento"},
];
...
function App(){
 ...
 for(const k of Object.keys(defs)){
     ...
     if(k==="acomp"&&obraId==="lote_d18"&&v&&Array.isArray(v)&&v.length>0){
      ...
      if(k==="crono"&&chaveDef==="madalena"&&v&&typeof v==="object"){
