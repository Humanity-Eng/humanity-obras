...
function Empreitada({E,sv,A,svA}){
 ...
 <td style={{padding:"7px 10px",color:"#64748b",cursor:"pointer"}} onClick={()=>{setEditUnit({empId:e.id,ii});setEditUnitForm({unit:it.unit||0,und:it.und||"M2"});}}>{it.und} ✏️</td>
 ...
 <td style={{padding:"7px 10px",textAlign:"right"}}>
      <span onClick={()=>{setEditUnit({empId:e.id,ii});setEditUnitForm({unit:it.unit||0,und:it.und||"M2"});}} style={{cursor:"pointer",color:it.unit>0?"#64748b":"#ef4444",fontWeight:it.unit>0?400:700}}>
       {it.unit>0?fmtBR(it.unit):"definir ✏️"}
      </span>
     </td>
