...
const VERSAO="2026.08.31 · build 44";
const OBRAS_REF=[{id:"obra_madalena",nome:"EMEIF MADALENA RAAF — Reforma",cliente:"Prefeitura Municipal de Belém",local:"Belém/PA",inicio:"01/08/2026",contrato:1245357.82,status:"Em andamento"}];
...
export default function App(){
 ...
 useEffect(()=>{
  (async()=>{
   ...
   let ajustou=false;
   lista=lista.map(o=>{
    if(chaveObra(o.id,o)==="madalena"&&(Number(o.contrato)===1518833.98||Number(o.contrato)===1200000)){ajustou=true;return{...o,contrato:1245357.82};}
    return o;
   });
...
const ORC_MADALENA={
 ...
 "PRÉDIO ADMINISTRATIVO":{
  ...
  "ESQUADRIAS":[{cod:"94569",desc:"JANELA DE ALUMÍNIO TIPO MAXIM-AR, BATENTE/ REQUADRO 3 A 14 CM, VIDRO INCLUSO, FIXAÇÃO COM PARAFUSO, SEM GUARNIÇÃO/ ALIZAR, DIMENSÕES 60X80 (A X L) CM, SEM ACABAMENTO, VEDAÇÃO COM SILICONE, EXCLUSIVE CONTRAMARCO - FORNECIMENTO E INSTALAÇÃO. AF_11/2024",und:"m²",qtd:23.08,unit:690.04,total:15926.12}],
 ...
 "QUADRA POLIESPORTIVA":{
  ...
  "COBERTURA":[{cod:"100330",desc:"RETIRADA E RECOLOCAÇÃO DE TELHA CERÂMICA CAPA-CANAL, COM ATÉ DUAS ÁGUAS, INCLUSO IÇAMENTO. AF_06/2026",und:"m²",qtd:278.8,unit:33.43,total:9320.28},{cod:"94218",desc:"TELHAMENTO COM TELHA ESTRUTURAL DE FIBROCIMENTO E= 8 MM, COM ATÉ 2 ÁGUAS, INCLUSO IÇAMENTO. AF_06/2026",und:"m²",qtd:50,unit:277.64,total:13882}],
 },
};
const IC_MADALENA=[
...
const IR_MADALENA=[
 {data:"Medição set/26",venc:"31/10/2026",prev:173751.13,rec:0,obs:"Recebimento no mês seguinte à medição"},
 {data:"Medição out/26",venc:"30/11/2026",prev:252878.86,rec:0,obs:"Recebimento no mês seguinte à medição"},
 {data:"Medição nov/26",venc:"31/12/2026",prev:210986.27,rec:0,obs:"Recebimento no mês seguinte à medição"},
 {data:"Medição dez/26",venc:"31/01/2027",prev:220894.74,rec:0,obs:"Recebimento no mês seguinte à medição"},
 {data:"Medição jan/27",venc:"28/02/2027",prev:244867.15,rec:0,obs:"Recebimento no mês seguinte à medição"},
 {data:"Medição fev/27",venc:"31/03/2027",prev:141979.67,rec:0,obs:"Recebimento no mês seguinte à medição"},
];
