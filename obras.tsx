...
const VERSAO="2026.09.24 · build 55";
      ...
      {!pdfReg.carregando&&(
       <div>
        <div style={{maxHeight:340,overflowY:"auto",border:"1px solid #e2e8f0",borderRadius:8,padding:8,background:"#fff"}}>
         <div id="rdo-pdf" style={{background:"#fff",padding:14,fontFamily:"Arial,sans-serif",width:"185mm"}}>
   ...
   {modal&&(
    <Modal onClose={()=>{setModal(false);setEdit(null);}} title={edit?"Editar diário":"Novo diário de obra"}>
     ...
     <Bloco titulo={"6. Fotos do serviço * — "+(form.fotos||[]).length+" anexada(s)"} cor="#0ea5e9">
      <div style={{fontSize:11,color:"#64748b",marginBottom:8,lineHeight:1.5}}>Obrigatória ao menos uma foto comprovando a execução. As imagens são reduzidas automaticamente antes de salvar.</div>
   ...
   {aberto&&(
    <Modal onClose={()=>setAberto(false)} title={titulo}>
     <div style={{maxHeight:360,overflowY:"auto",border:"1px solid #e2e8f0",borderRadius:8,padding:8,background:"#fff"}}>
      <div id={id} style={{background:"#fff",padding:14,fontFamily:"Arial,sans-serif",width:paisagem?"272mm":"190mm"}}>
       {children}
      </div>
     </div>
     <div style={{display:"flex",gap:10,marginTop:14}}>
